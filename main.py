...
class Flashcard:
    def __init__(self, question, answer, next_review=None, interval=1):
        self.question = question
        self.answer = answer
        self.next_review = datetime.now() if next_review is None else datetime.fromisoformat(next_review)
